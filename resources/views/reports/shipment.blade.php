...
@section('content')
    <div class="space-y-4">
        ...
        <div class="flex items-center gap-2 flex-wrap">
            ...
            <a href="{{ route('exports.shipment.pdf', array_merge(request()->query(), ['filename' => 'laporan-pengiriman-' . now()->format('Y-m-d_H-i-s') . '.pdf'])) }}" download="laporan-pengiriman.pdf"
            ...
            <a href="{{ route('exports.shipment.excel', array_merge(request()->query(), ['filename' => 'laporan-pengiriman-' . now()->format('Y-m-d_H-i-s') . '.xlsx'])) }}"
