...
@section('content')
    <div class="space-y-4">
        ...
        <div class="flex items-center gap-2 flex-wrap">
            ...
            <a href="{{ route('exports.stock.pdf', array_merge(request()->query(), ['filename' => 'laporan-stok-' . now()->format('Y-m-d_H-i-s') . '.pdf'])) }}" download="laporan-stok.pdf"
            ...
            <a href="{{ route('exports.stock.excel', array_merge(request()->query(), ['filename' => 'laporan-stok-' . now()->format('Y-m-d_H-i-s') . '.xlsx'])) }}"
            ...
            <a href="{{ route('exports.stock.csv', array_merge(request()->query(), ['filename' => 'laporan-stok-' . now()->format('Y-m-d_H-i-s') . '.csv'])) }}"
