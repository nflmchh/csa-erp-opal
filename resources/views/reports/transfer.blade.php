...
@section('content')
    <div class="space-y-4">
        ...
        <div class="flex items-center gap-2 flex-wrap">
            ...
            <a href="{{ route('exports.transfer.pdf', array_merge(request()->query(), ['filename' => 'laporan-transfer-toko-' . now()->format('Y-m-d_H-i-s') . '.pdf'])) }}" download="laporan-transfer-toko.pdf"
            ...
            <a href="{{ route('exports.transfer.excel', array_merge(request()->query(), ['filename' => 'laporan-transfer-toko-' . now()->format('Y-m-d_H-i-s') . '.xlsx'])) }}"
